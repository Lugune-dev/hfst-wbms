...
<div class="py-16 sm:py-24" style="background: var(--surface-bg);">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid gap-10 lg:grid-cols-2">
            ...
            <div class="glass-card rounded-2xl overflow-hidden flex flex-col md:flex-row transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
                ...
                <div class="p-8 md:w-2/3 flex flex-col justify-center">
                    <span class="text-xs font-bold uppercase tracking-widest mb-2" style="color: var(--brand-green);">
                        {{ $program->status }}
                    </span>
                    ...
                    <a href="{{ route('donate') }}"
                       class="inline-flex items-center font-semibold transition-all hover:gap-2"

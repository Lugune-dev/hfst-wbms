<x-filament-widgets::widget>
    <x-filament::section>
        ...
        <x-slot name="headerEnd">
            <a href="/teacher/students/create" class="text-xs font-semibold text-primary-600 hover:underline">+ Sajili Mpya</a>
        </x-slot>
        ...
        <div class="divide-y divide-gray-100 dark:divide-white/5">
            ...
            @empty
                <div class="text-center py-10 text-gray-400">
                    ...
                    <a href="/teacher/students/create" class="mt-2 inline-block text-xs font-bold text-primary-600 hover:underline">Sajili Mwanafunzi</a>
                </div>
            @endforelse
        </div>
    </x-filament::section>

<x-filament-widgets::widget>
    ...
    <div class="relative overflow-hidden rounded-2xl shadow-lg"
         style="background: linear-gradient(135deg, #1e5080 0%, #13385E 50%, #2E7D32 100%);">
        ...
        <div class="relative z-10 p-6 sm:p-8 text-white">
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-5">
                ...
                <div class="flex-1">
                    <p class="text-sm font-medium text-white/70">Karibu kwenye Dashibodi ya Mwalimu</p>
                    <h2 class="text-2xl sm:text-3xl font-black tracking-tight">Teacher Portal</h2>
                    <p class="text-sm text-white/80 mt-1">Hope for Students Tanzania — Usimamizi wa Wanafunzi</p>
                </div>
            </div>
            ...
            <div class="mt-6 grid grid-cols-2 lg:grid-cols-4 gap-3">
                <div class="rounded-xl p-3 border border-white/10" style="background: rgba(255,255,255,0.08);">
                    ...
                    <p class="text-lg font-black text-blue-300 mt-0.5">{{ $data['total_students'] }}</p>
                </div>
                <div class="rounded-xl p-3 border border-white/10" style="background: rgba(255,255,255,0.08);">
                ...
                <div class="rounded-xl p-3 border border-white/10" style="background: rgba(255,255,255,0.08);">
                    ...
                    <p class="text-lg font-black text-yellow-300 mt-0.5">{{ $data['graduated_students'] }}</p>
                </div>
                <div class="rounded-xl p-3 border border-white/10" style="background: rgba(255,255,255,0.08);">

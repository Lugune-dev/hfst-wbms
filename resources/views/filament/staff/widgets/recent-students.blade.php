        ...
        <div class="px-5 py-4 flex items-center justify-between"
            ...
            <div class="flex items-center gap-2.5">
                ...
                <div>
                    ...
                    <p class="text-xs text-green-100">Waliojisajili hivi karibuni</p>
                </div>
            </div>
            <a href="/staff/students/create" class="text-xs font-bold px-3 py-1.5 rounded-lg transition-all hover:scale-105" style="background: #F6B219; color: #13385E;">
                + Sajili Mpya
            </a>
        </div>
            ...
            <div class="divide-y divide-gray-50 dark:divide-white/5">
                ...
                @empty
                    <div class="text-center py-10 text-gray-400">
                        ...
                        <a href="/staff/students/create" class="mt-3 inline-block text-xs font-bold text-primary-600 hover:underline">Sajili Mwanafunzi</a>
                    </div>
                @endforelse
            </div>
        </div>

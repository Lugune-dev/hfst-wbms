...
<body class="font-sans antialiased hfst-body flex flex-col min-h-screen">
    ...
    <div class="mobile-drawer-backdrop" id="mobile-menu-backdrop" aria-hidden="true"></div>
    ...
    (function(){
        ...
        function initMobileMenu(){
            ...
            function closeMenu(){
                ...
                mBtn.classList.remove('hamburger-btn--open');
            ...
            function toggleMenu(){
                ...
                if(backdrop) backdrop.classList.toggle('mobile-drawer-backdrop--open', open);
            ...
            // Reset when resized to desktop viewport
            window.addEventListener('resize', function(){
                if(window.innerWidth >= 1024 && drawer.classList.contains('mobile-drawer--open')){
                    closeMenu();
                }
            });
        }

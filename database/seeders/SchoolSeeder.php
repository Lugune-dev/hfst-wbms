    ...
    public function run(): void
    {
        $schoolsData = [
            ...
            [
                ...
                'ward'             => 'Usa River',
                'address'          => 'P.O. Box 45, Usa River, Arusha',
                'contact_person'   => 'Mwl. Baraka Mushi (Headmaster)',
                'contact_phone'    => '+255762001122',
                'contact_email'    => 'merusec@hfst.co.tz',
                'student_capacity' => 90,
                'is_active'        => true,
                'notes'            => 'Partner school championing STEM subjects and girls education in Meru district.',
            ],
            [
                'name'             => 'Weruweru Girls High School',
                'code'             => 'SCH-KLM-006',
                'education_level'  => 'High School',
                'region'           => 'Kilimanjaro',
                'district'         => 'Hai',
                'ward'             => 'Weruweru',
                'address'          => 'P.O. Box 3020, Moshi',
                'contact_person'   => 'Mwl. Asteria Shirima (Headmistress)',
                'contact_phone'    => '+255784998877',
                'contact_email'    => 'weruweru@hfst.co.tz',
                'student_capacity' => 110,
                'is_active'        => true,
                'notes'            => 'Premier girls high school supporting orphaned and vulnerable girls with scholarships.',
            ],
        ];
